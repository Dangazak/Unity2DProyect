...
//http://dreamlo.com/lb/djY0n-u3zk-sqrNbadmemw-dBFZxa3D0aPoMTfL4Egxg
public class HighScores : MonoBehaviour
{
    const string privateCode = "djY0n-u3zk-sqrNbadmemw-dBFZxa3D0aPoMTfL4Egxg";  //Key to Upload New Info
    const string publicCode = "6106aa6e8f40bb25a0dbfdc4";   //Key to download
